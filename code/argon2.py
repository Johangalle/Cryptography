...
# based on Bas Westerbaan's argon2pure implementation.
# See https://github.com/bwesterb/argon2pure
# Bas Westerbaan <bas@westerbaan.name>
#
# I removed the six dependency (required for Pyhton2.7 compatibility) to eliminate
# the need for other libraries that need to be installed.
# Licensed under the Apache License, Version 2.0
# http://www.apache.org/licenses/
#
# This module supports password-based key derivation using the argon2 algorithm.
#
